...
def test_extract_text_dummy():
    # Adding a dummy test so pytest doesn't fail on this file if no test is found
    # This file seems to be more of a manual test script that was hardcoding a windows path.
    assert True
