...
- **Files**: backend/{api,indexing,background,database,agent,providers,model_manager,llm_integration,file_processing,tools}.py, backend/tests/*, frontend/src/{App,components/*,lib/*,test/*}, requirements.txt, package-lock.json, .gitignore, .dockerignore, internal_audit_log.md, internal_fix_log.md, AGENTS.md
